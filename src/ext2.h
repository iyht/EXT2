...
#define EXT2_BLOCK_SIZE 1024 //This is in bytes
...
struct ext2_dir_entry {
	unsigned int   inode;     /* Inode number size:4 */
	unsigned short rec_len;   /* Directory entry lexngth size:2 */
	unsigned char  name_len;  /* Name length  size: 1*/
	unsigned char  file_type; /* size: 1 */
